  ...
  return (
    <div className='container p-4 mx-auto'>
      ...
      <div className='mt-4 flex gap-4 justify-end items-center flex-wrap'>
        <button className='text-sm rounded-md border-2 border-sky-500 py-2 px-4'>Cancel</button>
        <button className='text-sm rounded-md border-2 border-sky-500 py-2 px-4'>Save as draft</button>
        <button className='text-sm rounded-md border-2 border-transparent bg-sky-500 py-2 px-4 text-white'>Publish</button>
      </div>
    </div>
  )
}
